...
fs.readFile(`/Users/rob/Library/Application Support/minecraft/saves/${level}/level.dat`, (error, data) => {
  if (error) throw error;

  nbt.parse(data, (error, data) => {
    // console.log(JSON.stringify(data.value.data.value.Villages.value.value))
