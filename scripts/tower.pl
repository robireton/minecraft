...
my ($x0, $y0, $z0) = (-247, 86, 426);
my ($floor_height, $floors) = (5, 8);
my $height = 1 + $floor_height * $floors;
my ($block, $stairs, $window, $light, $fence, $gate) = ('minecraft:stonebrick', 'minecraft:stone_brick_stairs', 'minecraft:iron_bars', 'minecraft:sea_lantern', 'minecraft:fence', 'minecraft:fence_gate');

#clear the area above
fill(-10,  1, -10,  10, $height+10,  10, 'minecraft:air');
...
#decorative facade
fill(-5, 2, -3,  -5, $height - 1,  3, 'minecraft:stone', 1);
fill(-3, 2,  5,   3, $height - 1,  5, 'minecraft:stone', 1);
fill( 3, 2, -5,  -3, $height - 1, -5, 'minecraft:stone', 1);
fill( 5, 2,  3,   5, $height - 1, -3, 'minecraft:stone', 1);
...
for my $floor (1 .. $floors) {
    ...
    for my $i (-1, 1) {
        fill(  -1, $y-4, 5*$i,     1, $y-1, 5*$i, 'minecraft:stone', 2);
        fill(5*$i, $y-4,   -1,  5*$i, $y-1,    1, 'minecraft:stone', 2);
    ...
    for my $x (-1, 1) {
        for my $z (-1, 1) {
            ...
            setblock( 2*$x, $y, 2*$z, 'minecraft:stone_slab', 13);
...
for my $x (-1, 1) {
    for my $z (-1, 1) {
        ...
        #spires
        fill(4*$x, 1+$height, 4*$z, 4*$x, 6+$height, 4*$z, 'minecraft:stone', 1);
        setblock(4*$x, 7+$height, 4*$z, $light);
    }
}

setblock(0, 6+$height, 0, 'minecraft:stone_slab', 13);
