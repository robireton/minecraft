...
my ($block, $stairs, $window, $light, $fence) = ('minecraft:nether_brick', 'minecraft:nether_brick_stairs', 'minecraft:iron_bars', 'minecraft:glowstone', 'minecraft:nether_brick_fence');
...
#decorative facade
fill(-5, 2, -3,  -5, $height - 1,  3, 'minecraft:obsidian');
fill(-3, 2,  5,   3, $height - 1,  5, 'minecraft:obsidian');
fill( 3, 2, -5,  -3, $height - 1, -5, 'minecraft:obsidian');
fill( 5, 2,  3,   5, $height - 1, -3, 'minecraft:obsidian');
...
for my $floor (1 .. $floors) {
    ...
    for my $i (-1, 1) {
        setblock(    0, $y-2, 5*$i, $window);
        setblock(    0, $y-3, 5*$i, $window);
        setblock( 5*$i, $y-2,    0, $window);
        setblock( 5*$i, $y-3,    0, $window);
    }
    ...
    for my $x (-1, 1) {
        for my $z (-1, 1) {
            ...
            setblock( 2*$x, $y, 2*$z, 'minecraft:stone_slab', 14);
...
for my $x (-1, 1) {
    for my $z (-1, 1) {
        ...
        #spires
        fill(4*$x, 1+$height, 4*$z, 4*$x, 6+$height, 4*$z, 'minecraft:obsidian');
        setblock(4*$x, 7+$height, 4*$z, $light);
    }
}

setblock(0, 6+$height, 0, 'minecraft:stone_slab', 14);
